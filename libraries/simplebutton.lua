...
function ButtonManager.draw(b)
	...
	if b then
		...
		if b.enabled then
			lg.setColor(0, 0, 0) -- Added this line to get black background for the buttons
	
		if not b.interactable then
			b.currentColor = b.disabledColor
		end
				
		--lg.setColor(b.currentColor[1], b.currentColor[2], b.currentColor[3], b.currentColor[4] or 1) -- Removed this line as it was messing the text/background colors
		...
		lg.setColor(255, 255, 255) -- Added this to get white text
